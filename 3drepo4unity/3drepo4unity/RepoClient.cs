...
namespace RepoForUnity
{
    ...
    public class RepoClient
    {
        ...
        /**
         * Connect to 3D Repo Web Services
         * This will connect to API services for https://www.3drepo.io using an API key
         * The user will have to connect before any API calls can be made.
         * @params apiKey key generated by the user
         * @return returns true upon success
         */

        public bool Connect(string apiKey)
        {
            if (!client.VersionCheck())
            {
                throw new RepoUnsupportedException();
